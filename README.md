...
Milestones M1–M5 are complete. The application now includes the PostgreSQL/RLS
...
policy PDF indexing, grounded questions, refusals, and page citations. M6
(LangGraph hybrid assistant) is next. See
